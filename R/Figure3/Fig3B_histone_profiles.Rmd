...
library(dplyr)
library(tidyr)
library(here); i_am("R/Figure3/Fig3B_histone_profiles.Rmd")
```

```{r}
k4 = read.delim(here("31_leafcutter/histone_profile", "H3K4me3","H3K4me3_white_beige-10.profile.tab"), skip=1)
...
ggsave(here("31_leafcutter/histone_profile", "H3K4me3","H3K4me3_white_beige-10.profile.R.pdf"), width=10, height=5)
#+ 
...
## H3K27ac
```{r}
k27 = read.delim(here("31_leafcutter/histone_profile", "H3K27ac","H3K27ac_white_beige-10.profile.tab"), skip=1)
...
ggsave(here("31_leafcutter/histone_profile", "H3K27ac","H3K27ac_white_beige-10.profile.R.pdf"), width=10, height=5)
...
```{r}
me1 = read.delim(here("31_leafcutter/histone_profile", "H3K4me1/H3K4me1_white_beige-10.profile.tab"), skip=1)
...
ggplot(me1) + geom_line(aes(x=distance, y=enrichment, group=TSS_set, color=TSS_set, linetype=TSS_set), size=0.5) + 
  facet_wrap(~Context) + theme_classic(base_size=22) +scale_color_manual(values= c("dodgerblue","orange","black")) +
  scale_linetype_manual(values=c("solid","solid","dashed"))
ggsave(here("31_leafcutter/histone_profile", "H3K4me1","H3K4me1_white_beige-10.profile.R.pdf"), width=10, height=5)
...
```{r}
pc = read.delim(here("31_leafcutter/histone_profile", "H3K27me3/H3K27me3_white_beige-10.profile.tab"), skip=1)
...
ggsave(here("31_leafcutter/histone_profile", "H3K27me3","H3K27me3_white_beige-10.profile.R.pdf"), width=10, height=5)
...
```{r}
pparg = read.delim(here("31_leafcutter/histone_profile", "PPARG/PPARG_white_beige-10.profile.tab"), skip=1)
...
ggsave(here("31_leafcutter/histone_profile", "PPARG","PPARG_white_beige-10.profile.R.pdf"), width=15, height=5)
...
##MED1
```{r}
med1 = read.delim(here("31_leafcutter/histone_profile", "MED1/MED1_white_beige-10.profile.tab"), skip=1)
...
ggsave(here("31_leafcutter/histone_profile", "MED1","MED1_white_beige-10.profile.R.pdf"), width=15, height=5)
