...
ggplot(filter(pparg_perc,pparg_set!="total"), aes(x=tss_set, y=fraction, fill=tss_set)) + geom_bar(stat='identity') + 
  ...
  labs(y="Proportion of PPARG-bound promoters") + facet_wrap(~pparg_set, switch ="x") +
    theme(axis.text.x = element_blank(), axis.ticks.x = element_blank(), strip.placement="outside",strip.background =element_blank(),
